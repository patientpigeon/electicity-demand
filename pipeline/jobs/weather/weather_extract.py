...
def main(city: str, start_date: str, end_date: str, spark=None):
    ...
    api_location, api_hour, api_astro, columns_to_select = sh.load_config_keys(
        job_config_file, "api_location", "api_hour", "api_astro", "columns_to_select"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--end_date",
        type=str,
        default=sh.default_end_date(),
        help="End date in YYYY-MM-DD format. Default is yesterday.",
    )
